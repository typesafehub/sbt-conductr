...
[![GitHub version](https://img.shields.io/badge/version-2.2.3-blue.svg)](https://github.com/typesafehub/sbt-conductr/releases)
...
```scala
addSbtPlugin("com.lightbend.conductr" % "sbt-conductr" % "2.2.3")
```
